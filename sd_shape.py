...
base_path = "onnx-stable-diffusion-v2-1"
os.makedirs(base_path, exist_ok=True)
enc_model_path = base_path + "/text_encoder_model.onnx"
unet_model_path = base_path + "/unet_model.onnx"
vae_decoder_path = base_path + "/vae_decoder.onnx"
